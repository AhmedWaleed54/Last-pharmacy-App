...
class _CustomBottomNavigationBarState extends State<CustomBottomNavigationBar>
  ...
  void didChangeDependencies() {
    _xController.value =
        _indexToPosition(_selectedIndex) / MediaQuery
            .of(context)
            .size
            .width;
  ...
  Widget _icon(IconData icon, bool isEnable, int index, onTap()) {
    return Expanded(
      child: InkWell(
        ...
        children: [
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: <Widget>[
                _icon(Icons.home, _selectedIndex == 0, 0, onTap),
                _icon(Icons.search, _selectedIndex == 1, 1, onTap),
                _icon(Icons.card_travel, _selectedIndex == 2, 2, onTap),
                _icon(Icons.favorite_border, _selectedIndex == 3, 3, onTap),
              ],
            ),
          ),
        ],
