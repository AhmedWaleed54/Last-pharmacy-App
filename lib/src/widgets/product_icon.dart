...
import 'package:last_gp/src/widgets/title_text.dart';
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: model.isSelected
                    ...
                    : Colors.transparent,
                border: Border.all(
                  color: model.isSelected ? LightColor.lightBlue : LightColor.grey,
              ...
              child: Row(
                children: <Widget>[
                  model.image != null ? Image.asset(model.image??'user.png') : SizedBox(),
                  model.name == null
                      ? Container()
                      : Container(
                          child: TitleText(
